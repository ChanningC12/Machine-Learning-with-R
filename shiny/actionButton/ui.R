...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            p("Click on the Update button to update and display the last name. Here the reactiveness of the input widget controlled by actionButton on the client and isolate on the server side")
            ),
